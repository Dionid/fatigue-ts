...
export type Event<Type, Version extends string, Data extends Record<any, any>> = {
  type: Type
  data: Data
  version: Version
}
...
export function EventFactory<E extends Event<any, any, any>>(type: E['type'], version: E['version']): EventFactory<E>
export function EventFactory<E extends Event<any, any, any>, AdditionalFns extends Record<string, any>>(
  type: E['type'],
  version: E['version'],
...
export type EventBus = {
  unsubscribe: <E extends Event<any, any, any>>(eventName: E['type'], eventHandler: EventHandler<FullEvent<E>>) => void
  subscribe<E extends Event<any, any, any>>(eventName: E['type'], eventHandler: EventHandler<FullEvent<E>>): () => void
  publish(events: readonly FullEvent[]): void
  commit(): Promise<void>
  rollback(): Promise<void>
  pull<E extends FullEvent>(eventName: E['type']): Promise<E>
  observe<E extends FullEvent>(eventName: E['type']): AsyncGenerator<{ stop: () => void; data: E }, void, unknown>
  tx(): EventBus
}
